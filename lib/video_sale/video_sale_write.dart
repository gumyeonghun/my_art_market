...
class VideoSaleWrite extends StatefulWidget {
  const VideoSaleWrite({super.key});

  @override
  State<VideoSaleWrite> createState() => _VideoSaleWriteState();
}

class _VideoSaleWriteState extends State<VideoSaleWrite> {
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();
  final TextEditingController videoAddressController = TextEditingController();
  final TextEditingController thumbnailUrlController = TextEditingController();
  final VideoSaleService _videoSaleService = VideoSaleService();
  ...
  Future<void> onCreate() async {
    if (titleController.text.isEmpty ||
        ...
        videoAddressController.text.isEmpty) {
    ...
    try {
      ...
      await _videoSaleService.addSale(
        title: titleController.text,
        content: contentController.text,
        videoAddress: videoAddressController.text,
  ...
  void dispose() {
    ...
    videoAddressController.dispose();
              ...
              Padding(
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      maxLines: 1,
                      controller: videoAddressController,
                      decoration: const InputDecoration(
                        hintText: '영상 파일 주소',
                      ),
                    ),
