...
class VideoSaleDetail extends StatefulWidget {
  const VideoSaleDetail({
    required this.docId,
    required this.title,
  ...
  @override
  State<VideoSaleDetail> createState() => _VideoSaleDetailState();
}

class _VideoSaleDetailState extends State<VideoSaleDetail> {
  final VideoSaleService _service = VideoSaleService();
  late TextEditingController _titleController;
  late TextEditingController _contentController;
  late TextEditingController _videoAddressController;
  ...
  void initState() {
    ...
    _videoAddressController = TextEditingController(text: widget.videoAddress);
  ...
  void dispose() {
    ...
    _videoAddressController.dispose();
  ...
  Future<void> _saveChanges() async {
    try {
      await _service.updateSale(
        ...
        videoAddress: _videoAddressController.text,
            ...
            IconButton(
              ...
              onPressed: () {
                setState(() {
                  ...
                  _videoAddressController.text = widget.videoAddress;
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                if (_isEditing)
                  TextField(
                    controller: _videoAddressController,
                    decoration: const InputDecoration(
                      labelText: '영상 주소',
                      border: OutlineInputBorder(),
                    ),
                  ...
                  GestureDetector(
                    onTap: () => _launchURL(widget.videoAddress),
                    child: Container(
                      decoration: BoxDecoration(
